...
{
    public class YharonPack : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot) {
            AddItem(itemLoot, "YharonSoulFragment", 100);
            AddItem(itemLoot, "AuricBar", 100);
        }

        public override void RightClick(Player player) {
            player.GetModPlayer<Common.ModIntegration.ModIntegrationPlayer>().SetFlag("Calamity_Yharon");
        }

        public override void AddRecipes() {
            int ingr = CalamityItemHelper.GetItemType("YharonSoulFragment");
